...
export const metadata: Metadata = {
  ...
  description: "GenAI-powered civic platform to report public issues, access government services, and get personalized assistance through an intelligent AI companion. Focused on transparency, accessibility, and digital inclusion.",
};
